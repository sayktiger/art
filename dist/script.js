...
/* harmony import */ var _modules_filster__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/filster */ "./src/js/modules/filster.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_filster__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_modules_pictureSize__WEBPACK_IMPORTED_MODULE_8__["default"])(".sizes-block");
  Object(_modules_accardion__WEBPACK_IMPORTED_MODULE_9__["default"])(".accordion-heading", ".accordion-block");
...
var accardion = function accardion(triggerSelector, blockSelector) {
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault(); //Скрываем форму при отправке
      ...
      }, 400); //Добавляем спинер при отправке на страницу

      var statusImg = document.createElement("img");
      statusImg.setAttribute("src", message.spinner);
      statusImg.classList.add("animated", "fadeInUp");
      statusMessage.appendChild(statusImg); //Добавляем текст при отправке
...
var modals = function modals() {
  ...
  openByScroll(".fixed-gift"); // showModalBindTime(`.popup-consultation` , 60000);
};
